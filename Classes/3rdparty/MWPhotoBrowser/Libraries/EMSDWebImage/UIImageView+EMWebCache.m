...
- (void)sd_setImageWithURLDeviceOne:(NSURL *)url placeholderImage:(UIImage *)placeholder {
    [self sd_setImageWithURLDeviceOne:url placeholderImage:placeholder options:0 progress:nil completed:nil];
}
...
- (void)sd_setImageWithURLDeviceOne:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(EMSDWebImageOptions)options progress:(EMSDWebImageDownloaderProgressBlock)progressBlock completed:(EMSDWebImageCompletionBlock)completedBlock {
