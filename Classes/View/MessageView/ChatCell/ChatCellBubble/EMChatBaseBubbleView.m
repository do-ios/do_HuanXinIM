...
- (void)setModel:(MessageModel *)model
{
    ...
    NSString *fileName = [filePath stringByAppendingFormat:@"/%@.png",imageName];
    ...
    self.backImageView.image = [[UIImage imageWithContentsOfFile:fileName] stretchableImageWithLeftCapWidth:leftCapWidth topCapHeight:topCapHeight];
}
