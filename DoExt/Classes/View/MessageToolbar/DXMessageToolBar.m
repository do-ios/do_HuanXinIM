...
- (void)setupSubviews
{
    ...
    NSString *fileChatBar_record =[filePath stringByAppendingPathComponent:@"chatBar_record.png"];
    
    NSString *fileChatBar_keyboard =[filePath stringByAppendingPathComponent:@"chatBar_keyboard.png"];
    self.styleChangeButton.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
    [self.styleChangeButton setImage:[UIImage imageWithContentsOfFile:fileChatBar_record] forState:UIControlStateNormal];
    [self.styleChangeButton setImage:[UIImage imageWithContentsOfFile:fileChatBar_keyboard] forState:UIControlStateSelected];
    ...
    NSString *fileChatBar_more =[filePath stringByAppendingPathComponent:@"chatBar_more.png"];
    
    NSString *fileChatBar_moreSel =[filePath stringByAppendingPathComponent:@"chatBar_moreSelected.pmg"];
    
    
    [self.moreButton setImage:[UIImage imageWithContentsOfFile:fileChatBar_more] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:fileChatBar_moreSel] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageWithContentsOfFile:fileChatBar_keyboard] forState:UIControlStateSelected];
    ...
    NSString *fileName = [filePath stringByAppendingPathComponent:@"chatBar_face.png"];
    [self.faceButton setImage:[UIImage imageWithContentsOfFile:fileName] forState:UIControlStateNormal];
    NSString *fileSelectedName = [filePath stringByAppendingPathComponent:@"chatBar_faceSelected.png"];
    [self.faceButton setImage:[UIImage imageWithContentsOfFile:fileSelectedName] forState:UIControlStateHighlighted];
    NSString *fileKeynoardName = [filePath stringByAppendingPathComponent:@"chatBar_keyboard.png"];
    [self.faceButton setImage:[UIImage imageWithContentsOfFile:fileKeynoardName] forState:UIControlStateSelected];
...
//    _inputTextView.placeHolder = NSLocalizedString(@"message.toolBar.inputPlaceHolder", @"input a new message");
    ...
    NSString *filerecorName = [filePath stringByAppendingPathComponent:@"chatBar_recordBg.png"];
    [self.recordButton setBackgroundImage:[[UIImage imageWithContentsOfFile:filerecorName]stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateNormal];
